 ...
 * Innovix — Login Page
 *
 * OAuth login via Supabase (Google + GitHub).
...
export default function Login() {
  ...
  const { isAuthenticated, signInWithGoogle, signInWithGithub } = useAuthStore()
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <Card className="w-full max-w-md glass-card border-white/10 glow-purple">
