        ...
        {showDialog && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 shadow-sm rounded-2xl p-6 w-full max-w-sm border border-slate-200 dark:border-slate-700"
            >
              {/* Header */}
              ...
              <div className="space-y-2 mb-5">
                  ...
                  className={`w-full flex items-center gap-3 p-3 rounded-lg border transition-all text-left
                    ${
                      exportFormat === 'md'
                        ...
                        : 'bg-slate-50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 hover:border-white/20'
                    }`}
                >
                  <FileText className={`w-5 h-5 ${exportFormat === 'md' ? 'text-blue-600 dark:text-blue-400' : 'text-muted-foreground'}`} />
                  <div>
                ...
                >
                  <FileDown className={`w-5 h-5 ${exportFormat === 'pdf' ? 'text-blue-600 dark:text-blue-400' : 'text-muted-foreground'}`} />
                  <div>
                ...
                >
                  <Presentation className={`w-5 h-5 ${exportFormat === 'pptx' ? 'text-blue-600 dark:text-blue-400' : 'text-muted-foreground'}`} />
                  <div>
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => setShowDialog(false)}
                  className="flex-1 px-4 py-2.5 rounded-lg bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700
                             text-sm text-muted-foreground hover:bg-slate-100 dark:bg-slate-800 transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 px-4 py-2.5 rounded-lg bg-gradient-to-r from-violet-600 to-purple-600
                             text-white text-sm font-medium hover:from-blue-600 hover:to-indigo-600
